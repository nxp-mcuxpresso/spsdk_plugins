...
if (SpsdkProtocolEnum := getattr(spsdk_debug_probe, "DebugProbeProtocol", None)) is not None:
    assert SpsdkProtocolEnum.SWD.label == DebugProbeProtocol.SWD.label
    assert SpsdkProtocolEnum.JTAG.label == DebugProbeProtocol.JTAG.label
    assert SpsdkProtocolEnum.ONCE.label == DebugProbeProtocol.ONCE.label
